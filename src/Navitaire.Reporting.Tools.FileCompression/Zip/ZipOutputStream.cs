...
using Navitaire.Reporting.Tools.FileCompression.Checksums;
using Navitaire.Reporting.Tools.FileCompression.Zip.Compression;
using Navitaire.Reporting.Tools.FileCompression.Zip.Compression.Streams;

namespace Navitaire.Reporting.Tools.FileCompression.Zip 
{
	/// <summary>
